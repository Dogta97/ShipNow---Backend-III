...
describe("Orders API", function () {
    ...
    describe("GET /api/orders", function () {
        ...
        it("debería obtener la lista de pedidos", async function () {
            ...
            expect(order).to.have.property("priority", "NORMAL");
            ...
            expect(order.products[0]).to.have.property(
                "quantity",
                2
            );

            expect(order.products[0].product).to.have.property(
                "name",
                "Producto Test"
            );
        });
    ...
    describe("GET /api/orders/:id", function () {
        ...
        it("debería obtener un pedido por ID", async function () {
            ...
            expect(response.body.products[0]).to.have.property(
                "quantity",
                1
            );
        ...
        it("debería devolver 404 si el pedido no existe", async function () {
    ...
    describe("POST /api/orders", function () {
        ...
        it("debería crear un pedido válido", async function () {
    ...
    describe("PUT /api/orders/:id/status", function () {
        ...
        it("debería actualizar correctamente el estado de un pedido", async function () {
